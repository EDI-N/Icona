...
У *Налаштування - Налаштування комплектів документів*, при `додаванні звязку пакета з типами документів`_ можливо налаштувати правила роботи з документом.
...
.. _`додаванні звязку пакета з типами документів`: https://perevod.readthedocs.io/ru/1.0/demo/Captain.html#пакет-тип-документа
