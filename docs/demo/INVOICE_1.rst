...
Возможно вносить изменения в количество и цену позиций.
...
.. image:: pic_INVOICE/INVOICE_007.png
   :align: center
...
Вид созданного документа соответствует документу «**Счет**» (INVOICE) созданному на основе **Заказа (Подтверждения заказа)**, однако все поля необходимо заполнить самостоятельно. В новом документе, все поля обозначенные красной звёздочкой * обязательны для заполнения.
